...
-- สร้างฟังก์ชัน TP สำหรับ tweening
function TP(Pos)
...
local X2Codes = { -- แก้ชื่อตัวแปรเป็น X2Codes
    "TheGreatAce",        
    "Bignews",      
    "Fudd10",
    "Axiore",
...
Tab1:Button("RedeemCodeX2",function()
    local function RedeemCode(code) -- แก้ชื่อฟังก์ชันเป็น RedeemCode และอาร์กิวเมนต์เป็น code
        game:GetService("ReplicatedStorage").Remotes.Redeem:InvokeServer(code)
    end
    for i,code in pairs(X2Codes) do -- แก้ชื่อตัวแปร v เป็น code
        RedeemCode(code)
    end
end)
...
-- กำหนดค่าตัวแปรหรืออ็อบเจกต์ที่ไม่ได้แสดงในโค้ดเดิม
local CommF_ = game:GetService("ReplicatedStorage").Remotes.CommF_

-- เพิ่มปุ่ม TravelMain
Tab2:Button("TravelMain", function(value)
    -- เรียกใช้งานฟังก์ชั่นที่ต้องการผ่านทางอ็อบเจกต์ที่กำหนดไว้ด้านบน
    CommF_:InvokeServer("TravelMain")
end)

-- เพิ่มปุ่ม TravelDressrosa
...
elseif id == 7449423635 then
    Tab2:Dropdown("Teleport in world 3",{"Port Town", "Hydra Island", "Great Tree", "Mansion", "Haunted Castle", "Castle on the Sea", "Sea of Treats", "Tiki Outpost"},function(t)
        _G.Teleport = t
    end)
