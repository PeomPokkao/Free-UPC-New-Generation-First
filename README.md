...
local WE = Selectweapon:AddDropdown({
    Name = "Select Weapon",
Default = "Select Weapon",
Options = {Weapon, Weapon, Weapon},
Callback = function(Value)
...
function Equip(ToolX)
    if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(ToolX) then
        game.Players.LocalPlayer.Character.Humanoid:EquipTool(game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(ToolX))
    end
end
    ...
    while wait(.1) do
        pcall(function()
            if _G.Auto_Equip then
                game.Players.LocalPlayer.Character.Humanoid:EquipTool(game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(_G.SelectWeaponLocal))
end
end)
end
end)
...
if _G.Auto_Equip then
pcall(function()
game.Players.LocalPlayer.Character.Humanoid:EquipTool(game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(Name))
end)
end
end
end)

local KY = Selectweapon::AddButton({
        Name = "Refresh Weapon",
        Callback = function()
            SelectWeapon:Clear()
